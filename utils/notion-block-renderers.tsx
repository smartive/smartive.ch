...
import { CodeSnippet, MermaidDiagram } from '../src/components/code-snippet';
import { Image } from '../src/components/image';
import { NotionRichText } from '../src/components/notion-rich-text';
import { OrderedList } from '../src/components/ordered-list';
import { UnorderedList } from '../src/components/unordered-list';
import { Video } from '../src/components/video';
import { YoutubeVideo } from '../src/components/youtube-video';
import { Link } from '../src/elements/link';
import { Block, BlockType } from '../src/services/notion';
...
const internalRenderers = {
  ...
  heading_1: createRenderer('heading_1', ({ id, heading_1: { rich_text } }) => (
    <Heading1 className="mt-16 lg:mt-28" key={id}>
      <NotionRichText text={rich_text} />
    </Heading1>
  )),
  heading_2: createRenderer('heading_2', ({ id, heading_2: { rich_text } }) => (
    <Heading2 className="mt-12 lg:mt-24" key={id}>
      <NotionRichText text={rich_text} />
    </Heading2>
  )),
  heading_3: createRenderer('heading_3', ({ id, heading_3: { rich_text } }) => (
    <Heading3 className="mt-12 lg:mt-24" key={id}>
      <NotionRichText text={rich_text} />
    </Heading3>
  )),
