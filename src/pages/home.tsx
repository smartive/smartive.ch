    ...
    <Page>
      ...
      <main>
        ...
        <PageSection title="Storyblok stuff customers">
          {contentOfStory.body.map((cos) => (
            <CustomerList2 key={cos._uid} blok={cos} />
          ))}
        </PageSection>
      ...
      <script src="//app.storyblok.com/f/storyblok-latest.js?t=y6SrqQaQmeNAsYSQjrNHRAtt"></script>
    </Page>
  );
};
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  StoryblokService.setQuery(`home`);

  return {
    props: {
      storyblokContent: await StoryblokService.get('cdn/stories/home', {}),
      packages,
