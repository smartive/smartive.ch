    ...
    <LandingPage>
      <PageHeader
        ...
        tags={[
          ...
          { short: 'User Experience', full: 'Kategorie User Experience' },
        ]}
      >
        <Copy>
      ...
      <main>
        ...
        <Section title="Deine Finanzen. Ohne das Chaos.">
          <Copy>
            Finanzen: Das sind 5 Plattformen, 8 Telefonnummern, 19 Ordner und dieses Postit auf dem Zettel, das irgendwo im
            3. Fächli von oben liegt. Unterm Strich: hä plusminus unklar Franken.
          </Copy>
          <Copy>
            Den Überblick über die Finanzen und vor allem die Anlagestrategie zu behalten, ist ein kleiner Nebenjob. Dabei
            willst du eigentlich gar nicht wissen, ob der 6. Posten auf Seite 2 genau 52’931.45 oder doch 49’872.15 beträgt.
            Sondern was dich im Alter erwartet, was du mal vererben wirst, wie chic und zentral das Haus werden darf und ob
            die Firma noch Luft hat bis zum Break even.
          </Copy>
          <Copy>
            Die ZWEI Plattform ist dein Headquarter. Hier findest du alle Infos, hier steht dein*e Berater*in für Fragen zur
            Verfügung, deine Dokumente und – wenn du magst – noch viel mehr Zahlen, Grafiken und Tabellen. Das Wichtigste ist
        ...
        <Section title="Management summary oder Deep dive?">
          <Copy>Du hast Fragen zu deinen Finanzen? Gut so!</Copy>
          <Copy>
            <strong>First things first.</strong> Die ZWEI Wealth Plattform beantwortet die Fragen, die du zu deinem Vermögen
            hast, in logischer Reihenfolge. Zuerst: Ist mein Lebensstandard gesichert und reicht die Liquidität für alles,
            was mir vorschwebt? Damit du sofort weisst, wie liquide du bist, ohne durch eine Ladung grüner und roter Pfeile
            scrollen zu müssen, die tief in den Finanzdschungel zeigen.
          </Copy>
          <Copy>
            Usability war die Top-Anforderung bei der Entwicklung. Die Plattform ist von den Nutzer*innen her gedacht: Was
            will man zuerst sehen? Das Resultat ist eine Gliederung, die so funktioniert, wie Menschen denken: Über
            Bedürfnisse, Beziehungen und Projekte statt über Profite und Zahlen.
          </Copy>
          <Copy>
            <strong>Deep dive?</strong> Aber gerne. Du willst die ganze Geschichte, tausend Pfeile, sexy Grafiken,
            Zahlensalat und Tabellen? – Go for it! Mit einem Klick geht’s ins Detail. Das ganze entweder im Browser oder zum
            herunterladen als PDF. Nur Salat haben wir heute leider nicht.
          </Copy>
        </Section>
      </main>
