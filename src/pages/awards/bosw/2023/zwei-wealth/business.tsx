    ...
    <LandingPage>
      ...
      <main>
        ...
        <Section title="Wenn alle gewinnen, gewinnen alle">
          <Copy>
            Für Banken und Vermögensverwalter eröffnet sich ein neuer Distributionskanal. Sie können sich auf die
            Anlagestrategien konzentrieren, nach von ZWEI Wealth vorgegebenen Kriterien – und damit auf das, was sie richtig
            gut können.
          </Copy>
          <Copy>
            Durch die Benchmarking-Funktion gewinnen sie Feedback: Wie schneiden wir ab im Vergleich mit anderen Banken (die
            natürlich anonym bleiben)? Die Challenge hilft den Banken, ihr Angebot zu verbessern.
          </Copy>
          <Copy as="div">
            <Image
              priority
              src="/images/awards/bosw/2023/zwei-benchmarking.jpg"
              alt="ZWEI Wealth Vermögensplattform"
              width={1504}
              height={667}
            />
          ...
          <Copy>
            Als Bindeglied zwischen Kunde und Vermögensverwalter kann ZWEI Wealth unabhängig beraten. Ohne Kickbacks, mit
