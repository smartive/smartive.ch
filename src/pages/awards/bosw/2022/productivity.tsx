    ...
    <LandingPage>
      ...
      >
        <Copy>
          ...
          Bottom-up-Initiative steigert der Community Value Loop die Produktivität im Umgang mit Kundenfeedbacks.
        </Copy>
      </PageHeader>
      ...
      <main>
        <Section>
          ...
          <Keyfigure background="mint">
            <Image
              priority
              src="/images/awards/bosw/2022/mcc-value-loop.svg"
              alt="Der Community Value Loop"
              width={600}
              height={600}
            />
          </Keyfigure>
          ...
          <Grid cols={3}>
            <div>
              ...
              <Copy>
                ...
                auf Migipedia.ch sowie im sonntäglichen Migros-Newsletter zum Einsatz.
              </Copy>
            </div>
        ...
        <Section>
          <Heading2>Von Excel zum &laquo;Instagram der Produkte&raquo;</Heading2>
          <Copy>
            ...
            Bisher wurden den Category-Managers der Migros diese Community-Aktivitäten in regelmässigen Abständen als Excel
            mit hunderten von Zeilen zugestellt. Vereinzelt flossen Kundenfeedbacks so in die Erfolgsmessung oder Optimierung
            von Produkten ein. Um den Umgang mit Produktbewertungen den internen Migros-Stakeholder zu vereinfachen, wurde
            eine Daily E-Mail geschaffen, welche individuell auf Sortiments- und Themen-Verantwortlichkeiten konfiguriert
            werden kann. Im Gegensatz zum bisherigen Excel, werden die Feedbacks heute mit Bild und Text täglich in die Inbox
            geliefert.
          </Copy>
        </Section>
        ...
        <Section>
          ...
          <Copy>
            ...
            nutzbar und verschaffen dem Unternehmen so einen Wettbewerbsvorteil. Das gewählte Bottom-up-Vorgehen zur
            Lancierung des Value Loops ist ein Grund für die hohe Akzeptanz bei den Migros-Mitarbeitenden.
          </Copy>
        </Section>
        ...
        <Section>
          ...
          <Copy>
            ...
            Daily E-Mail, was die Übersicht und die Effizienz steigert. Seit dem Sommer zeigten Woche für Woche weitere
            Personen unterschiedlicher Abteilungen Interesse an individuellen Daily E-Mails. Im November war es so weit: Der
            Migros-Community Value Loop mit seinen digitalen, automatisierten Massnahmen wurde der Departementsleitung
            Marketing als innovatives Beispiel für Data-driven Retail für noch mehr Kundenfokus und Produktivität
            vorgestellt.
          </Copy>
        </Section>
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  return {
    props: {
      quote: Quotes['bettina-bosw22-productivity'],
    },
  };
};
