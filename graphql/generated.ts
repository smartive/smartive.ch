...
/** Block of type 🏷️ Label (label) */
export type LabelRecord = RecordInterface & {
...
/** Block of type 🏷️ Label (label) */
export type LabelRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
export type PageModelContentField = ContactRecord | CustomRecord | ImageGridRecord | ImageRecord | ImageTextRecord | KeyfigureRecord | LogoGridRecord | OffersTeaserRecord | ProjectIntroRecord | ProjectsOverviewRecord | ProjectsTeaserRecord | QuoteRecord | TextRecord | ThreeColsTextRecord | TwoColsTextRecord | VideoRecord;
...
export type ProjectIntroModelContentField = {
  __typename?: 'ProjectIntroModelContentField';
  blocks: Array<Scalars['String']['output']>;
  links: Array<Scalars['String']['output']>;
  value: Scalars['JsonField']['output'];
};

/** Block of type 🚀 Intro (project_intro) */
export type ProjectIntroRecord = RecordInterface & {
  __typename?: 'ProjectIntroRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt?: Maybe<Scalars['DateTime']['output']>;
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']['output']>;
  _updatedAt: Scalars['DateTime']['output'];
  content?: Maybe<ProjectIntroModelContentField>;
  id: Scalars['ItemId']['output'];
...
/** Block of type 🚀 Intro (project_intro) */
export type ProjectIntroRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};

export type ProjectModelContentField = ContactRecord | CustomRecord | ImageGridRecord | ImageRecord | ImageTextRecord | KeyfigureRecord | LogoGridRecord | OffersTeaserRecord | ProjectIntroRecord | ProjectsOverviewRecord | ProjectsTeaserRecord | QuoteRecord | TextRecord | ThreeColsTextRecord | TwoColsTextRecord | VideoRecord;
...
export type ProjectTagModelDescriptionBlocksField = LabelRecord | LinkRecord;

export type ProjectTagModelDescriptionField = {
  __typename?: 'ProjectTagModelDescriptionField';
  blocks: Array<ProjectTagModelDescriptionBlocksField>;
  links: Array<Scalars['String']['output']>;
  value: Scalars['JsonField']['output'];
};
...
export type ProjectTagRecord = RecordInterface & {
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']['output']>;
  _updatedAt: Scalars['DateTime']['output'];
  description?: Maybe<ProjectTagModelDescriptionField>;
  id: Scalars['ItemId']['output'];
  seometatags?: Maybe<SeoField>;
  slug: Scalars['String']['output'];
  title: Scalars['String']['output'];
...
export type Query = {
  ...
  /** Returns meta information regarding a record collection */
  _allTeasersMeta: CollectionMetadata;
  /** Returns meta information regarding a record collection */
...
/** The query root for this schema */
export type Query_AllTeasersMetaArgs = {
  filter?: InputMaybe<TeaserModelFilter>;
  locale?: InputMaybe<SiteLocale>;
};
...
/** The query root for this schema */
export type QueryAllTeasersArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  filter?: InputMaybe<TeaserModelFilter>;
  first?: InputMaybe<Scalars['IntType']['input']>;
  locale?: InputMaybe<SiteLocale>;
  orderBy?: InputMaybe<Array<InputMaybe<TeaserModelOrderBy>>>;
  skip?: InputMaybe<Scalars['IntType']['input']>;
};
...
export type TeaserModelFilter = {
  AND?: InputMaybe<Array<InputMaybe<TeaserModelFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<TeaserModelFilter>>>;
  _createdAt?: InputMaybe<CreatedAtFilter>;
  _firstPublishedAt?: InputMaybe<PublishedAtFilter>;
  _isValid?: InputMaybe<BooleanFilter>;
  _publicationScheduledAt?: InputMaybe<PublishedAtFilter>;
...
export enum TeaserModelOrderBy {
  CreatedAtAsc = '_createdAt_ASC',
  CreatedAtDesc = '_createdAt_DESC',
  FirstPublishedAtAsc = '_firstPublishedAt_ASC',
  FirstPublishedAtDesc = '_firstPublishedAt_DESC',
...
export type TextModelContentBlocksField = LabelRecord | LinkRecord;
...
export type ThreeColsTextModelContentLeftBlocksField = ImageRecord | LabelRecord | LinkRecord;
...
export type ThreeColsTextModelContentMiddleBlocksField = ImageRecord | LabelRecord | LinkRecord;
...
export type ThreeColsTextModelContentRightBlocksField = ImageRecord | LabelRecord | LinkRecord;
...
export type TwoColsTextModelContentLeftBlocksField = ImageRecord | LabelRecord | LinkRecord;
...
export type TwoColsTextModelContentRightBlocksField = ImageRecord | LabelRecord | LinkRecord;
...
export type CustomBlockFragment = { __typename?: 'CustomRecord', id: string, component?: string | null };
...
export type ProjectIntroBlockFragment = { __typename?: 'ProjectIntroRecord', id: string, content?: { __typename?: 'ProjectIntroModelContentField', value: unknown } | null, links: Array<{ __typename?: 'LinkRecord', id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }>, tags: Array<{ __typename?: 'TagRecord', id: string, label: string }> };
...
export type TextBlockFragment = { __typename?: 'TextRecord', id: string, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, content?: { __typename?: 'TextModelContentField', value: unknown, blocks: Array<{ __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null };

export type ThreeColsTextBlockFragment = { __typename?: 'ThreeColsTextRecord', id: string, heading?: string | null, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, contentLeft?: { __typename?: 'ThreeColsTextModelContentLeftField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null, contentMiddle?: { __typename?: 'ThreeColsTextModelContentMiddleField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null, contentRight?: { __typename?: 'ThreeColsTextModelContentRightField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null };

export type TwoColsTextBlockFragment = { __typename?: 'TwoColsTextRecord', id: string, heading?: string | null, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, contentLeft?: { __typename?: 'TwoColsTextModelContentLeftField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null, contentRight?: { __typename?: 'TwoColsTextModelContentRightField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null };
...
export type LabelsFragment = { __typename?: 'LabelRecord', id: string, label: string, color?: string | null };
...
export type PageQuery = { __typename?: 'Query', page?: { __typename?: 'PageRecord', id: string, content: Array<{ __typename: 'ContactRecord', id: string, text: string, smartiveEmployeeName: string } | { __typename: 'CustomRecord', id: string, component?: string | null } | { __typename: 'ImageGridRecord', id: string, layout?: string | null, image1?: { __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } | null, image2?: { __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } | null, image3?: { __typename?: 'FileField', id: string, title?: string | null, responsiveImage?: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } | null } | null } | { __typename: 'ImageRecord', id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename: 'ImageTextRecord', id: string, layout?: string | null, image?: { __typename?: 'ImageFileField', responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } | null, content?: { __typename?: 'ImageTextModelContentField', value: unknown } | null } | { __typename: 'KeyfigureRecord', id: string, image?: { __typename?: 'ImageFileField', responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } | null, content?: { __typename?: 'KeyfigureModelContentField', value: unknown } | null } | { __typename: 'LogoGridRecord', id: string, heading?: string | null, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, logos: Array<{ __typename?: 'TitleFileField', id: string, url: string, width?: number | null, height?: number | null, title: string }> } | { __typename: 'OffersTeaserRecord', id: string, heading?: string | null, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, offers: Array<{ __typename?: 'OfferRecord', id: string, title: string, description?: string | null, timespan?: string | null, linkLabel?: string | null, legacyLink: string, color: string }> } | { __typename: 'ProjectIntroRecord', id: string, content?: { __typename?: 'ProjectIntroModelContentField', value: unknown } | null, links: Array<{ __typename?: 'LinkRecord', id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }>, tags: Array<{ __typename?: 'TagRecord', id: string, label: string }> } | { __typename: 'ProjectsOverviewRecord', id: string, selectedTestimonial?: { __typename?: 'TestimonialRecord', id: string, quote: string, authorName?: string | null, authorDesc?: string | null, authorImage?: { __typename?: 'ImageFileField', responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } | null } | null } | { __typename: 'ProjectsTeaserRecord', id: string, heading?: string | null, projects: Array<{ __typename?: 'ProjectRecord', id: string, slug: string, title: string, headline: string, teaserImage: { __typename?: 'ImageFileField', responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } }> } | { __typename: 'QuoteRecord', id: string, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, testimonial: Array<{ __typename?: 'TestimonialRecord', id: string, quote: string, authorName?: string | null, authorDesc?: string | null, authorImage?: { __typename?: 'ImageFileField', responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } | null }> } | { __typename: 'TextRecord', id: string, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, content?: { __typename?: 'TextModelContentField', value: unknown, blocks: Array<{ __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null } | { __typename: 'ThreeColsTextRecord', id: string, heading?: string | null, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, contentLeft?: { __typename?: 'ThreeColsTextModelContentLeftField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null, contentMiddle?: { __typename?: 'ThreeColsTextModelContentMiddleField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null, contentRight?: { __typename?: 'ThreeColsTextModelContentRightField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null } | { __typename: 'TwoColsTextRecord', id: string, heading?: string | null, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, contentLeft?: { __typename?: 'TwoColsTextModelContentLeftField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null, contentRight?: { __typename?: 'TwoColsTextModelContentRightField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null } | { __typename: 'VideoRecord', id: string, loop?: boolean | null, autoplay?: boolean | null, video?: { __typename?: 'VideoField', url: string, provider: string, providerUid: string, title: string } | null }>, seo: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }> } | null, site: { __typename?: 'Site', favicon: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }>, globalSeo?: { __typename?: 'GlobalSeoField', titleSuffix?: string | null, fallbackSeo?: { __typename?: 'SeoField', description?: string | null, title?: string | null } | null } | null } };
...
export type ProjectQuery = { __typename?: 'Query', project?: { __typename?: 'ProjectRecord', id: string, content: Array<{ __typename: 'ContactRecord', id: string, text: string, smartiveEmployeeName: string } | { __typename: 'CustomRecord', id: string, component?: string | null } | { __typename: 'ImageGridRecord', id: string, layout?: string | null, image1?: { __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } | null, image2?: { __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } | null, image3?: { __typename?: 'FileField', id: string, title?: string | null, responsiveImage?: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } | null } | null } | { __typename: 'ImageRecord', id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename: 'ImageTextRecord', id: string, layout?: string | null, image?: { __typename?: 'ImageFileField', responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } | null, content?: { __typename?: 'ImageTextModelContentField', value: unknown } | null } | { __typename: 'KeyfigureRecord', id: string, image?: { __typename?: 'ImageFileField', responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } | null, content?: { __typename?: 'KeyfigureModelContentField', value: unknown } | null } | { __typename: 'LogoGridRecord', id: string, heading?: string | null, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, logos: Array<{ __typename?: 'TitleFileField', id: string, url: string, width?: number | null, height?: number | null, title: string }> } | { __typename: 'OffersTeaserRecord', id: string, heading?: string | null, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, offers: Array<{ __typename?: 'OfferRecord', id: string, title: string, description?: string | null, timespan?: string | null, linkLabel?: string | null, legacyLink: string, color: string }> } | { __typename: 'ProjectIntroRecord', id: string, content?: { __typename?: 'ProjectIntroModelContentField', value: unknown } | null, links: Array<{ __typename?: 'LinkRecord', id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }>, tags: Array<{ __typename?: 'TagRecord', id: string, label: string }> } | { __typename: 'ProjectsOverviewRecord', id: string, selectedTestimonial?: { __typename?: 'TestimonialRecord', id: string, quote: string, authorName?: string | null, authorDesc?: string | null, authorImage?: { __typename?: 'ImageFileField', responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } | null } | null } | { __typename: 'ProjectsTeaserRecord', id: string, heading?: string | null, projects: Array<{ __typename?: 'ProjectRecord', id: string, slug: string, title: string, headline: string, teaserImage: { __typename?: 'ImageFileField', responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } }> } | { __typename: 'QuoteRecord', id: string, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, testimonial: Array<{ __typename?: 'TestimonialRecord', id: string, quote: string, authorName?: string | null, authorDesc?: string | null, authorImage?: { __typename?: 'ImageFileField', responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } } | null }> } | { __typename: 'TextRecord', id: string, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, content?: { __typename?: 'TextModelContentField', value: unknown, blocks: Array<{ __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null } | { __typename: 'ThreeColsTextRecord', id: string, heading?: string | null, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, contentLeft?: { __typename?: 'ThreeColsTextModelContentLeftField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null, contentMiddle?: { __typename?: 'ThreeColsTextModelContentMiddleField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null, contentRight?: { __typename?: 'ThreeColsTextModelContentRightField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null } | { __typename: 'TwoColsTextRecord', id: string, heading?: string | null, disableMarginTop?: boolean | null, disableMarginBottom?: boolean | null, contentLeft?: { __typename?: 'TwoColsTextModelContentLeftField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null, contentRight?: { __typename?: 'TwoColsTextModelContentRightField', value: unknown, blocks: Array<{ __typename?: 'ImageRecord', _modelApiKey: string, id: string, images: Array<{ __typename?: 'ImageFileField', id: string, title?: string | null, responsiveImage: { __typename?: 'ResponsiveImage', src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null, sizes: string } }> } | { __typename?: 'LabelRecord', _modelApiKey: string, id: string, label: string, color?: string | null } | { __typename?: 'LinkRecord', _modelApiKey: string, id: string, label: string, newTab?: boolean | null, url: string, color?: string | null }> } | null } | { __typename: 'VideoRecord', id: string, loop?: boolean | null, autoplay?: boolean | null, video?: { __typename?: 'VideoField', url: string, provider: string, providerUid: string, title: string } | null }>, seo: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }> } | null, site: { __typename?: 'Site', favicon: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }>, globalSeo?: { __typename?: 'GlobalSeoField', titleSuffix?: string | null, fallbackSeo?: { __typename?: 'SeoField', description?: string | null, title?: string | null } | null } | null } };
...
export const ProjectIntroBlockFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"projectIntroBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ProjectIntroRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"content"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"links"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"links"}}]}},{"kind":"Field","name":{"kind":"Name","value":"tags"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"label"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"links"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LinkRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"label"}},{"kind":"Field","name":{"kind":"Name","value":"newTab"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}}]} as unknown as DocumentNode<ProjectIntroBlockFragment, unknown>;
...
export const LabelsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"labels"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LabelRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"label"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}}]} as unknown as DocumentNode<LabelsFragment, unknown>;
export const TextBlockFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"textBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"TextRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"content"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LinkRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"links"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LabelRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"labels"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginTop"}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginBottom"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"links"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LinkRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"label"}},{"kind":"Field","name":{"kind":"Name","value":"newTab"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"labels"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LabelRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"label"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}}]} as unknown as DocumentNode<TextBlockFragment, unknown>;
...
export const PageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Page"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"page"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"slug"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"content"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"TextRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"textBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"TwoColsTextRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"twoColsTextBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ThreeColsTextRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"threeColsTextBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ImageRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"imageBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"VideoRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"videoBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ProjectIntroRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"projectIntroBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ProjectsTeaserRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"projectsTeaserBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"QuoteRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"quoteBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ContactRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"contactBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OffersTeaserRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"offersTeaserBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"KeyfigureRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"keyfigureBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ImageTextRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"imageTextBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"CustomRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"customBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ImageGridRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"imageGridBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LogoGridRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"logoGridBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ProjectsOverviewRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"projectsOverviewBlock"}}]}}]}},{"kind":"Field","alias":{"kind":"Name","value":"seo"},"name":{"kind":"Name","value":"_seoMetaTags"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attributes"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"tag"}}]}}]}},{"kind":"Field","alias":{"kind":"Name","value":"site"},"name":{"kind":"Name","value":"_site"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"favicon"},"name":{"kind":"Name","value":"faviconMetaTags"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attributes"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"tag"}}]}},{"kind":"Field","name":{"kind":"Name","value":"globalSeo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"fallbackSeo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}},{"kind":"Field","name":{"kind":"Name","value":"titleSuffix"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"links"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LinkRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"label"}},{"kind":"Field","name":{"kind":"Name","value":"newTab"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"labels"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LabelRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"label"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"responsiveImage"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ResponsiveImage"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"src"}},{"kind":"Field","name":{"kind":"Name","value":"width"}},{"kind":"Field","name":{"kind":"Name","value":"height"}},{"kind":"Field","name":{"kind":"Name","value":"alt"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"base64"}},{"kind":"Field","name":{"kind":"Name","value":"sizes"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"imageBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ImageRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"images"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"responsiveImage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"imgixParams"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"w"},"value":{"kind":"IntValue","value":"1504"}},{"kind":"ObjectField","name":{"kind":"Name","value":"auto"},"value":{"kind":"EnumValue","value":"format"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"responsiveImage"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"textBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"TextRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"content"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LinkRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"links"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LabelRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"labels"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginTop"}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginBottom"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"twoColsTextBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"TwoColsTextRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"heading"}},{"kind":"Field","name":{"kind":"Name","value":"contentLeft"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ImageRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"imageBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LinkRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"links"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LabelRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"labels"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"contentRight"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ImageRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"imageBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LinkRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"links"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LabelRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"labels"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginTop"}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginBottom"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"threeColsTextBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ThreeColsTextRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"heading"}},{"kind":"Field","name":{"kind":"Name","value":"contentLeft"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ImageRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"imageBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LinkRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"links"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LabelRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"labels"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"contentMiddle"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ImageRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"imageBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LinkRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"links"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LabelRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"labels"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"contentRight"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"blocks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ImageRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"imageBlock"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LinkRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"links"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LabelRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_modelApiKey"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"labels"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginTop"}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginBottom"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"videoBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"VideoRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"video"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"provider"}},{"kind":"Field","name":{"kind":"Name","value":"providerUid"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}},{"kind":"Field","name":{"kind":"Name","value":"loop"}},{"kind":"Field","name":{"kind":"Name","value":"autoplay"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"projectIntroBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ProjectIntroRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"content"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"links"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"links"}}]}},{"kind":"Field","name":{"kind":"Name","value":"tags"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"label"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"projectsTeaserBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ProjectsTeaserRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"heading"}},{"kind":"Field","name":{"kind":"Name","value":"projects"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"headline"}},{"kind":"Field","name":{"kind":"Name","value":"teaserImage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"responsiveImage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"imgixParams"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"fit"},"value":{"kind":"EnumValue","value":"crop"}},{"kind":"ObjectField","name":{"kind":"Name","value":"w"},"value":{"kind":"IntValue","value":"720"}},{"kind":"ObjectField","name":{"kind":"Name","value":"h"},"value":{"kind":"IntValue","value":"480"}},{"kind":"ObjectField","name":{"kind":"Name","value":"auto"},"value":{"kind":"EnumValue","value":"format"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"responsiveImage"}}]}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"quoteBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"QuoteRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"testimonial"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"quote"}},{"kind":"Field","name":{"kind":"Name","value":"authorName"}},{"kind":"Field","name":{"kind":"Name","value":"authorDesc"}},{"kind":"Field","name":{"kind":"Name","value":"authorImage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"responsiveImage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"imgixParams"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"fit"},"value":{"kind":"EnumValue","value":"crop"}},{"kind":"ObjectField","name":{"kind":"Name","value":"w"},"value":{"kind":"IntValue","value":"128"}},{"kind":"ObjectField","name":{"kind":"Name","value":"h"},"value":{"kind":"IntValue","value":"128"}},{"kind":"ObjectField","name":{"kind":"Name","value":"auto"},"value":{"kind":"EnumValue","value":"format"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"responsiveImage"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginTop"}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginBottom"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"contactBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ContactRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"text"}},{"kind":"Field","name":{"kind":"Name","value":"smartiveEmployeeName"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"offersTeaserBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OffersTeaserRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"heading"}},{"kind":"Field","name":{"kind":"Name","value":"offers"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"timespan"}},{"kind":"Field","name":{"kind":"Name","value":"linkLabel"}},{"kind":"Field","name":{"kind":"Name","value":"legacyLink"}},{"kind":"Field","name":{"kind":"Name","value":"color"}}]}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginTop"}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginBottom"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"keyfigureBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"KeyfigureRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"image"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"responsiveImage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"imgixParams"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"w"},"value":{"kind":"IntValue","value":"300"}},{"kind":"ObjectField","name":{"kind":"Name","value":"auto"},"value":{"kind":"EnumValue","value":"format"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"responsiveImage"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"content"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"imageTextBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ImageTextRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"image"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"responsiveImage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"imgixParams"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"w"},"value":{"kind":"IntValue","value":"580"}},{"kind":"ObjectField","name":{"kind":"Name","value":"auto"},"value":{"kind":"EnumValue","value":"format"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"responsiveImage"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"content"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"value"}}]}},{"kind":"Field","name":{"kind":"Name","value":"layout"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"customBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"CustomRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"component"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"imageGridBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ImageGridRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"image1"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"responsiveImage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"imgixParams"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"fit"},"value":{"kind":"EnumValue","value":"crop"}},{"kind":"ObjectField","name":{"kind":"Name","value":"w"},"value":{"kind":"IntValue","value":"720"}},{"kind":"ObjectField","name":{"kind":"Name","value":"h"},"value":{"kind":"IntValue","value":"480"}},{"kind":"ObjectField","name":{"kind":"Name","value":"auto"},"value":{"kind":"EnumValue","value":"format"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"responsiveImage"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"image2"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"responsiveImage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"imgixParams"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"fit"},"value":{"kind":"EnumValue","value":"crop"}},{"kind":"ObjectField","name":{"kind":"Name","value":"w"},"value":{"kind":"IntValue","value":"720"}},{"kind":"ObjectField","name":{"kind":"Name","value":"h"},"value":{"kind":"IntValue","value":"480"}},{"kind":"ObjectField","name":{"kind":"Name","value":"auto"},"value":{"kind":"EnumValue","value":"format"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"responsiveImage"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"image3"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"responsiveImage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"imgixParams"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"fit"},"value":{"kind":"EnumValue","value":"crop"}},{"kind":"ObjectField","name":{"kind":"Name","value":"w"},"value":{"kind":"IntValue","value":"720"}},{"kind":"ObjectField","name":{"kind":"Name","value":"h"},"value":{"kind":"IntValue","value":"1024"}},{"kind":"ObjectField","name":{"kind":"Name","value":"auto"},"value":{"kind":"EnumValue","value":"format"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"responsiveImage"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"layout"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"logoGridBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LogoGridRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"heading"}},{"kind":"Field","name":{"kind":"Name","value":"logos"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"width"}},{"kind":"Field","name":{"kind":"Name","value":"height"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginTop"}},{"kind":"Field","name":{"kind":"Name","value":"disableMarginBottom"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"projectsOverviewBlock"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ProjectsOverviewRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","alias":{"kind":"Name","value":"selectedTestimonial"},"name":{"kind":"Name","value":"testimonial"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"quote"}},{"kind":"Field","name":{"kind":"Name","value":"authorName"}},{"kind":"Field","name":{"kind":"Name","value":"authorDesc"}},{"kind":"Field","name":{"kind":"Name","value":"authorImage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"responsiveImage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"imgixParams"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"fit"},"value":{"kind":"EnumValue","value":"crop"}},{"kind":"ObjectField","name":{"kind":"Name","value":"w"},"value":{"kind":"IntValue","value":"128"}},{"kind":"ObjectField","name":{"kind":"Name","value":"h"},"value":{"kind":"IntValue","value":"128"}},{"kind":"ObjectField","name":{"kind":"Name","value":"auto"},"value":{"kind":"EnumValue","value":"format"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"responsiveImage"}}]}}]}}]}}]}}]} as unknown as DocumentNode<PageQuery, PageQueryVariables>;
