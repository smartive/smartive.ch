...
export type VideoBlockFragment = { __typename?: 'VideoRecord', id: string, videoType: string, controls: boolean, loop: boolean, autoplay: boolean, video?: { __typename?: 'VideoField', url: string, provider: string, providerUid: string, title: string } | null, videoFile?: { __typename?: 'VideoFileField', width?: number | null, height?: number | null, blurUpThumb?: string | null, video: { __typename?: 'UploadVideoField', muxPlaybackId: string } } | null };
