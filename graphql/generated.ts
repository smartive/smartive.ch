...
export type SthTextModelElementField = CustomRecord | ImageRecord;

export type SthTextModelTextField = {
  __typename?: 'SthTextModelTextField';
  blocks: Array<Scalars['String']['output']>;
  links: Array<Scalars['String']['output']>;
  value: Scalars['JsonField']['output'];
};

/** Block of type 🌅 Sth & Text (sth_text) */
export type SthTextRecord = RecordInterface & {
  __typename?: 'SthTextRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt?: Maybe<Scalars['DateTime']['output']>;
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']['output']>;
  _updatedAt: Scalars['DateTime']['output'];
  element: Array<SthTextModelElementField>;
  id: Scalars['ItemId']['output'];
  text?: Maybe<SthTextModelTextField>;
  variant?: Maybe<Scalars['String']['output']>;
};


/** Block of type 🌅 Sth & Text (sth_text) */
export type SthTextRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
export type OffersTeaserBlockFragment = { __typename?: 'OffersTeaserRecord', id: string, heading?: string | null, offers: Array<{ __typename?: 'OfferRecord', id: string, title: string, description?: string | null, timespan?: string | null, linkLabel?: string | null, legacyLink: string, color: string }> };
...
export type LogoGridBlockFragment = { __typename?: 'LogoGridRecord', id: string, heading?: string | null, logos: Array<{ __typename?: 'TitleFileField', id: string, url: string, width?: number | null, height?: number | null, title: string }> };
